    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12 animate-on-scroll">
                <!-- Total Events -->
                <div class="group relative bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 p-6 rounded-3xl shadow-2xl shadow-blue-500/30 hover:shadow-3xl hover:shadow-blue-500/50 transform hover:scale-105 transition-all duration-500 overflow-hidden">
                    ...
                    <div class="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full -translate-y-8 translate-x-8 group-hover:scale-150 transition-transform duration-700"></div>
                    <div class="relative flex items-center justify-between">
                        <div>
                            ...
                            <div class="flex items-center mt-2">
                                ...
                                <span class="text-xs text-blue-100">Active</span>
                            </div>
                        </div>
                        <div class="p-3 bg-white/20 rounded-2xl group-hover:bg-white/30 transition-colors duration-300">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Total Users -->
                <div class="group relative bg-gradient-to-br from-purple-500 via-purple-600 to-pink-600 p-6 rounded-3xl shadow-2xl shadow-purple-500/30 hover:shadow-3xl hover:shadow-purple-500/50 transform hover:scale-105 transition-all duration-500 overflow-hidden">
                    <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full -translate-y-8 translate-x-8 group-hover:scale-150 transition-transform duration-700"></div>
                    <div class="relative flex items-center justify-between">
                        <div>
                            ...
                            <div class="flex items-center mt-2">
                                ...
                                <span class="text-xs text-purple-100">Registered</span>
                            </div>
                        </div>
                        <div class="p-3 bg-white/20 rounded-2xl group-hover:bg-white/30 transition-colors duration-300">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Pending Requests -->
                <div class="group relative bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 p-6 rounded-3xl shadow-2xl shadow-orange-500/30 hover:shadow-3xl hover:shadow-orange-500/50 transform hover:scale-105 transition-all duration-500 overflow-hidden">
                    <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full -translate-y-8 translate-x-8 group-hover:scale-150 transition-transform duration-700"></div>
                    <div class="relative flex items-center justify-between">
                        <div>
                            ...
                            <div class="flex items-center mt-2">
                                ...
                                <span class="text-xs text-orange-100">Awaiting Review</span>
                            </div>
                        </div>
                        <div class="p-3 bg-white/20 rounded-2xl group-hover:bg-white/30 transition-colors duration-300">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Recent Events -->
                <div class="group relative bg-gradient-to-br from-green-500 via-green-600 to-teal-600 p-6 rounded-3xl shadow-2xl shadow-green-500/30 hover:shadow-3xl hover:shadow-green-500/50 transform hover:scale-105 transition-all duration-500 overflow-hidden">
                    <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full -translate-y-8 translate-x-8 group-hover:scale-150 transition-transform duration-700"></div>
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="text-green-100 text-sm font-medium mb-1">Recent Events</p>
                ...
                <!-- Total Bookings -->
                <div class="group relative bg-gradient-to-br from-indigo-500 via-indigo-600 to-blue-600 p-6 rounded-3xl shadow-2xl shadow-indigo-500/30 hover:shadow-3xl hover:shadow-indigo-500/50 transform hover:scale-105 transition-all duration-500 overflow-hidden">
                    <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full -translate-y-8 translate-x-8 group-hover:scale-150 transition-transform duration-700"></div>
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="text-indigo-100 text-sm font-medium mb-1">Total Bookings</p>
                            <p class="text-3xl font-black text-white">{{ $totalBookings }}</p>
                            <div class="flex items-center mt-2">
                                <svg class="w-4 h-4 text-green-300 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                </svg>
                                <span class="text-xs text-indigo-100">Confirmed</span>
                            </div>
                        </div>
                        <div class="p-3 bg-white/20 rounded-2xl group-hover:bg-white/30 transition-colors duration-300">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mb-12 animate-on-scroll">
                <nav class="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-3" aria-label="Tabs">
                    <div class="absolute inset-0 bg-gradient-to-r from-blue-50/50 via-purple-50/50 to-pink-50/50 rounded-3xl"></div>
                    <div class="relative flex space-x-2">
                        <a href="#events" class="tab-link group flex-1 text-center py-4 px-6 rounded-2xl text-sm font-bold transition-all duration-500
                           ...
                           hover:shadow-xl hover:shadow-blue-500/50 hover:scale-105 active:scale-95" data-tab="events">
                        ...
                        <a href="#bookings" class="tab-link group flex-1 text-center py-4 px-6 rounded-2xl text-sm font-bold transition-all duration-500
                           text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-600
                           hover:shadow-lg hover:shadow-purple-500/30 hover:scale-105 active:scale-95" data-tab="bookings">
                            <div class="flex items-center justify-center gap-2">
                                <svg class="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                        ...
                        <a href="#users" class="tab-link group flex-1 text-center py-4 px-6 rounded-2xl text-sm font-bold transition-all duration-500
                           text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-green-500 hover:to-teal-600
                           hover:shadow-lg hover:shadow-green-500/30 hover:scale-105 active:scale-95" data-tab="users">
                            <div class="flex items-center justify-center gap-2">
                                <svg class="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                </svg>
                        ...
                        <a href="#requests" class="tab-link group flex-1 text-center py-4 px-6 rounded-2xl text-sm font-bold transition-all duration-500
                           text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-orange-500 hover:to-red-600
                           hover:shadow-lg hover:shadow-orange-500/30 hover:scale-105 active:scale-95" data-tab="requests">
                            <div class="flex items-center justify-center gap-2">
                                <svg class="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                </svg>
                        ...
                        <a href="#analytics" class="tab-link group flex-1 text-center py-4 px-6 rounded-2xl text-sm font-bold transition-all duration-500
                           text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-indigo-500 hover:to-blue-600
                           hover:shadow-lg hover:shadow-indigo-500/30 hover:scale-105 active:scale-95" data-tab="analytics">
                            <div class="flex items-center justify-center gap-2">
                                <svg class="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                </svg>
            ...
            <div id="events-tab" class="tab-content animate-on-scroll">
                <div class="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-50/50 via-purple-50/50 to-pink-50/50"></div>
                    <div class="relative p-8">
                        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
                            <div>
                                <h3 class="text-3xl font-black bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">
                                    Recent Events
                                </h3>
                                <p class="text-gray-600 text-lg">Manage and monitor your latest events</p>
                            </div>
                        ...
                        @if($recentEvents->count() > 0)
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                @foreach($recentEvents as $event)
                                    <div class="group relative bg-gradient-to-br from-white to-blue-50/50 p-6 rounded-3xl shadow-xl border border-white/50
                                        ...
                                        <div class="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-blue-400/20 to-purple-400/20 rounded-full -translate-y-10 translate-x-10 group-hover:scale-150 transition-transform duration-700"></div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <a href="{{ route('events.show', $event) }}"
                                               class="group/btn inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700
                                                      text-white px-6 py-3 rounded-2xl font-bold text-sm shadow-lg shadow-blue-500/30
            ...
            <div id="bookings-tab" class="tab-content hidden animate-on-scroll">
                <div class="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
                    <div class="absolute inset-0 bg-gradient-to-br from-purple-50/50 via-pink-50/50 to-rose-50/50"></div>
                    <div class="relative p-8">
                        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
                            <div>
                                <h3 class="text-3xl font-black bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">
                                    Recent Bookings
                                </h3>
                                <p class="text-gray-600 text-lg">Monitor ticket sales and booking activity</p>
                            </div>
            ...
            <div id="users-tab" class="tab-content hidden animate-on-scroll">
                <div class="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
                    <div class="absolute inset-0 bg-gradient-to-br from-green-50/50 via-teal-50/50 to-cyan-50/50"></div>
                    <div class="relative p-8">
                        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
                            <div>
                                <h3 class="text-3xl font-black bg-gradient-to-r from-green-600 to-teal-600 bg-clip-text text-transparent mb-2">
                                    User Management
                                </h3>
                                <p class="text-gray-600 text-lg">Monitor and manage user accounts and roles</p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                            <!-- Total Users Card -->
                            <div class="group relative bg-gradient-to-br from-white to-green-50/50 p-6 rounded-3xl shadow-xl border border-white/50
                                        hover:shadow-2xl hover:scale-105 transition-all duration-500 overflow-hidden">
                                ...
                                <div class="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-green-400/20 to-teal-400/20 rounded-full -translate-y-8 translate-x-8 group-hover:scale-150 transition-transform duration-700"></div>

                                <div class="relative">
                                    <div class="flex items-center justify-between mb-4">
                                        <div class="p-3 bg-gradient-to-r from-green-500 to-teal-500 rounded-2xl shadow-lg">
                                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                            </svg>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <p class="text-3xl font-black text-gray-900 mb-1">{{ $totalUsers }}</p>
                                        <p class="text-sm text-gray-600 font-medium">Total Users</p>
                                        <div class="flex items-center justify-center mt-2">
                                            <svg class="w-4 h-4 text-green-500 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                            </svg>
                                            <span class="text-xs text-green-600 font-medium">Registered</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
