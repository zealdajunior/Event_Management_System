        ...
        <div class="bg-gradient-to-r from-purple-900/80 via-pink-900/80 to-green-900/80 backdrop-blur-xl rounded-3xl p-6 mb-8 shadow-2xl border border-white/10">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-white/70 mt-2">Manage and track all payments</p>
                </div>
            </div>
        </div>
    </x-slot>
                ...
                <div class="relative p-8">
                    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
                        <div>
                            ...
                            <p class="text-white/70 text-lg">Comprehensive list of all payments in the system</p>
                        </div>
                        <a href="{{ route('payments.create') }}"
                           class="group relative bg-gradient-to-r from-purple-500 via-pink-600 to-green-600 hover:from-purple-600 hover:via-pink-700 hover:to-green-700
                            ...
                            <span class="relative z-10">Create New Payment</span>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl border border-white/10">
                                <thead class="bg-gradient-to-r from-purple-900/80 via-pink-900/80 to-green-900/80">
                                    <tr>
                                        <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Booking</th>
                                        <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Amount</th>
                                        <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase tracking-wider">Payment Method</th>
                                    ...
                                    @foreach($payments as $payment)
                                        <tr class="hover:bg-white/5 transition-colors duration-200">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-white">
                                                {{ $payment->booking ? $payment->booking->event->name : 'N/A' }}
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full {{ $payment->status == 'completed' ? 'bg-green-500/20 text-green-300 border border-green-500/30' : 'bg-yellow-500/20 text-yellow-300 border border-yellow-500/30' }}">
                    ...
                    @else
                        <div class="text-center py-16">
                            ...
                            <h4 class="text-2xl font-bold text-white mb-2">No Payments Found</h4>
                            <p class="text-white/70 text-lg mb-6">Start processing payments to see them here</p>
                            <a href="{{ route('payments.create') }}"
