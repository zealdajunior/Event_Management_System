...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl p-6 mb-6">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-4 py-2 bg-gray-500 text-white rounded-xl hover:bg-gray-600">
                    Back to Dashboard
                </a>
            </div>
        </div>
    ...
    <script>
        ...
        function processCheckIn(qrCode) {
            ...
            fetch('<?php echo e(route("attendance.check-in")); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH C:\Users\Zealda Junior\Desktop\Event\event_management\resources\views/attendance/scanner.blade.php ENDPATH**/ ?>