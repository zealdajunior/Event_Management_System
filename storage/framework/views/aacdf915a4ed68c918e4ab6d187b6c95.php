        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
                <div class="p-8">
                    ...
                    <form method="POST" action="<?php echo e(route('events.store')); ?>" enctype="multipart/form-data" x-data="{
...
<?php endif; ?>
                                    ...
                                    <div>
                                        <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'category','value' => __('Event Category *'),'class' => 'text-gray-700 font-semibold']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'category','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Event Category *')),'class' => 'text-gray-700 font-semibold']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581)): ?>
<?php $attributes = $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581; ?>
...
<?php endif; ?>
                                        <select id="category" class="block mt-1 w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg" name="category" required>
                                            ...
                                            <option value="conference" <?php echo e(old('category') == 'conference' ? 'selected' : ''); ?>>Conference</option>
                                            <option value="workshop" <?php echo e(old('category') == 'workshop' ? 'selected' : ''); ?>>Workshop</option>
                                            <option value="concert" <?php echo e(old('category') == 'concert' ? 'selected' : ''); ?>>Concert</option>
                                            <option value="sports" <?php echo e(old('category') == 'sports' ? 'selected' : ''); ?>>Sports</option>
                                            <option value="exhibition" <?php echo e(old('category') == 'exhibition' ? 'selected' : ''); ?>>Exhibition</option>
                                            <option value="networking" <?php echo e(old('category') == 'networking' ? 'selected' : ''); ?>>Networking</option>
                                            <option value="seminar" <?php echo e(old('category') == 'seminar' ? 'selected' : ''); ?>>Seminar</option>
                                            <option value="festival" <?php echo e(old('category') == 'festival' ? 'selected' : ''); ?>>Festival</option>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'location','class' => 'block mt-1 w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg','type' => 'text','name' => 'location','value' => old('location'),'required' => true,'autocomplete' => 'location','placeholder' => 'e.g., 123 Main Street, City, State, ZIP Code']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'location','class' => 'block mt-1 w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg','type' => 'text','name' => 'location','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('location')),'required' => true,'autocomplete' => 'location','placeholder' => 'e.g., 123 Main Street, City, State, ZIP Code']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Zealda Junior\Desktop\Event\event_management\resources\views/events/create.blade.php ENDPATH**/ ?>