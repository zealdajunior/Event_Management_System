...
<head>
    ...
    <title>User Management - <?php echo e(config('app.name', 'Event Management')); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg border-2 border-blue-100 hover:shadow-xl hover:scale-105 transition-all duration-300">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-black text-gray-900"><?php echo e($users->count()); ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-lg border-2 border-blue-100 hover:shadow-xl hover:scale-105 transition-all duration-300">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-black text-gray-900"><?php echo e($users->where('role', 'admin')->count()); ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-lg border-2 border-blue-100 hover:shadow-xl hover:scale-105 transition-all duration-300">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-black text-gray-900"><?php echo e($users->where('role', 'user')->count()); ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-lg border-2 border-blue-100 hover:shadow-xl hover:scale-105 transition-all duration-300">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-black text-gray-900"><?php echo e($users->where('created_at', '>=', now()->subDays(7))->count()); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tr class="hover:bg-blue-50 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-bold text-gray-900"><?php echo e($user->name ?? 'N/A'); ?></div>
                                                <div class="text-xs text-gray-500">ID: <?php echo e($user->id); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900"><?php echo e($user->email ?? 'N/A'); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full <?php echo e(($user->role ?? 'user') === 'admin' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'); ?>">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full <?php echo e($user->email_verified_at ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            <button onclick="viewUser(<?php echo e($user->id); ?>)" class="text-blue-600 hover:text-blue-900 p-2 hover:bg-blue-50 rounded-lg transition-colors">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                                </svg>
                                            </button>
                                            <button onclick="editUser(<?php echo e(json_encode($user)); ?>)" class="text-blue-600 hover:text-blue-900 p-2 hover:bg-blue-50 rounded-lg transition-colors">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->id !== Auth::id()): ?>
                                                <button onclick="confirmDelete(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>')" class="text-red-600 hover:text-red-900 p-2 hover:bg-red-50 rounded-lg transition-colors">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\Users\Zealda Junior\Desktop\Event\event_management\resources\views/users/index.blade.php ENDPATH**/ ?>