        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div id="analytics-tab" class="tab-content hidden animate-on-scroll">
                <div class="bg-white rounded-3xl shadow-sm p-8 border border-blue-50">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($auditLogs)): ?>
                    <div class="bg-white p-6 rounded-xl border border-blue-100 shadow-md mt-8">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $auditLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-blue-50 transition-colors duration-150">
                                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600">
                                            <?php echo e(\Carbon\Carbon::parse($log['timestamp'])->format('M d, H:i:s')); ?>

                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-8 w-8 bg-blue-100 rounded-full flex items-center justify-center">
                                                    <span class="text-blue-600 font-bold text-sm"><?php echo e(substr($log['user_name'], 0, 1)); ?></span>
                                                </div>
                                                <div class="ml-3">
                                                    <p class="text-sm font-semibold text-gray-900"><?php echo e($log['user_name']); ?></p>
                                                    <p class="text-xs text-gray-500">ID: <?php echo e($log['user_id']); ?></p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            ...
                                            ?>
                                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e($badgeClasses); ?>">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="text-sm">
                                                <p class="text-gray-900 font-medium"><?php echo e($log['resource_type']); ?></p>
                                                <p class="text-gray-500 text-xs">ID: <?php echo e($log['resource_id']); ?></p>
                                            </div>
                                        </td>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($auditLogs) === 0): ?>
        ...
        <div class="bg-white rounded-3xl shadow-sm p-4 sm:p-6 lg:p-8 border border-purple-50">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div class="bg-gradient-to-br from-purple-500 to-blue-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white">
                    ...
                    <p class="text-3xl sm:text-4xl font-black"><?php echo e(\App\Models\User::where('role', 'admin')->count()); ?></p>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white">
                    ...
                    <p class="text-3xl sm:text-4xl font-black"><?php echo e(\App\Models\User::where('role', 'user')->count()); ?></p>
                </div>
                ...
                <div class="bg-gradient-to-br from-orange-500 to-pink-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white">
                    ...
                    <p class="text-3xl sm:text-4xl font-black"><?php echo e(\App\Models\User::where('is_super_admin', true)->count()); ?></p>
                </div>
            </div>
            ...
            <div class="mt-6 sm:mt-8 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-purple-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                    <a href="<?php echo e(route('admin.management.index')); ?>" class="flex items-center p-3 sm:p-4 bg-white rounded-lg sm:rounded-xl border border-purple-200 hover:border-purple-400 hover:shadow-lg transition-all duration-300">
                    ...
                    <a href="<?php echo e(route('admin.management.index')); ?>#create-admin" class="flex items-center p-3 sm:p-4 bg-white rounded-lg sm:rounded-xl border border-green-200 hover:border-green-400 hover:shadow-lg transition-all duration-300">
            ...
            <div class="mt-6 sm:mt-8 bg-gray-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 text-center">
                    <div>
                        <p class="text-xl sm:text-2xl font-bold text-blue-600"><?php echo e(\App\Models\Event::count()); ?></p>
                        <p class="text-xs sm:text-sm text-gray-600 mt-1">Total Events</p>
                    </div>
                    <div>
                        <p class="text-xl sm:text-2xl font-bold text-green-600"><?php echo e(\App\Models\Booking::count()); ?></p>
                        <p class="text-xs sm:text-sm text-gray-600 mt-1">Total Bookings</p>
                    </div>
                    <div>
                        <p class="text-xl sm:text-2xl font-bold text-purple-600"><?php echo e(\App\Models\Payment::sum('amount')); ?></p>
                        <p class="text-xs sm:text-sm text-gray-600 mt-1">Total Revenue</p>
                    </div>
                    <div>
                        <p class="text-xl sm:text-2xl font-bold text-orange-600"><?php echo e(\App\Models\EventRequest::where('status', 'pending')->count()); ?></p>
