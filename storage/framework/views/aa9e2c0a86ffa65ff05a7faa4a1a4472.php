        ...
        <div class="bg-white rounded-3xl shadow-sm p-8 border border-purple-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-gradient-to-br from-purple-500 to-blue-600 rounded-2xl p-6 text-white">
                    ...
                    <p class="text-4xl font-black"><?php echo e(\App\Models\User::where('role', 'admin')->count()); ?></p>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-6 text-white">
                    ...
                    <p class="text-4xl font-black"><?php echo e(\App\Models\User::where('role', 'user')->count()); ?></p>
                </div>
                ...
                <div class="bg-gradient-to-br from-orange-500 to-pink-600 rounded-2xl p-6 text-white">
                    ...
                    <p class="text-4xl font-black"><?php echo e(\App\Models\User::where('is_super_admin', true)->count()); ?></p>
                </div>
            </div>
            ...
            <div class="mt-8 bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-6 border border-purple-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <a href="<?php echo e(route('admin.management.index')); ?>" class="flex items-center p-4 bg-white rounded-xl border border-purple-200 hover:border-purple-400 hover:shadow-lg transition-all duration-300">
                    ...
                    <a href="<?php echo e(route('admin.management.index')); ?>#create-admin" class="flex items-center p-4 bg-white rounded-xl border border-green-200 hover:border-green-400 hover:shadow-lg transition-all duration-300">
            ...
            <div class="mt-8 bg-gray-50 rounded-2xl p-6 border border-gray-200">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                    <div>
                        <p class="text-2xl font-bold text-blue-600"><?php echo e(\App\Models\Event::count()); ?></p>
                        <p class="text-sm text-gray-600 mt-1">Total Events</p>
                    </div>
                    <div>
                        <p class="text-2xl font-bold text-green-600"><?php echo e(\App\Models\Booking::count()); ?></p>
                        <p class="text-sm text-gray-600 mt-1">Total Bookings</p>
                    </div>
                    <div>
                        <p class="text-2xl font-bold text-purple-600"><?php echo e(\App\Models\Payment::sum('amount')); ?></p>
                        <p class="text-sm text-gray-600 mt-1">Total Revenue</p>
                    </div>
                    <div>
                        <p class="text-2xl font-bold text-orange-600"><?php echo e(\App\Models\EventRequest::where('status', 'pending')->count()); ?></p>
