...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['href' => ''.e(route('event-requests.create')).'','variant' => 'primary','size' => 'sm','class' => 'flex-1 sm:flex-none']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('event-requests.create')).'','variant' => 'primary','size' => 'sm','class' => 'flex-1 sm:flex-none']); ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('verification_reminder')): ?>
        <div class="bg-amber-50 border-l-4 border-amber-400 p-6 mx-4 rounded-r-lg">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-blue-700 font-medium"><?php echo e(session('verification_reminder')); ?></p>
                    <p class="text-blue-600 text-sm mt-1">
                        <a href="<?php echo e(route('verification.notice')); ?>" class="underline hover:text-blue-800">Click here to resend verification email</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user() && !auth()->user()->hasVerifiedEmail() && !(auth()->user()->is_super_admin ?? false)): ?>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-blue-600 text-sm mt-1">
                        ...
                        <a href="<?php echo e(route('verification.notice')); ?>" class="underline hover:text-blue-800">resend verification email</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasCreatedEvents): ?>
            ...
            <div class="bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-xl shadow-sm border border-blue-50 p-6 text-center animate-fade-in-up">
                ...
                <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <a href="<?php echo e(route('event-requests.create')); ?>" class="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-6 px-8 rounded-xl transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
                        Request Your First Event
                    </a>
                    <a href="<?php echo e(route('events.index')); ?>" class="inline-flex items-center justify-center gap-2 bg-white border-2 border-blue-400 hover:bg-blue-50 text-blue-700 font-bold py-6 px-8 rounded-xl transition-all duration-300 hover:shadow-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recommendedEvents && $recommendedEvents->count() > 0): ?>
            <div class="bg-white rounded-xl p-4 shadow-sm border border-blue-50 animate-slide-in-left">
                ...
                <div class="max-w-6xl mx-auto">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recommendedEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl p-6 shadow-sm card-hover border border-blue-200 border-blue-100/50 flex flex-col gradient-border" style="height: 520px;">
                        <div class="flex justify-between items-start mb-3" style="height: 28px;">
                            <div class="flex flex-wrap gap-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->category && is_object($event->category)): ?>
                                    <span class="text-xs font-bold px-2 py-1 rounded-full" 
                                          style="background-color: <?php echo e($event->category->color ?? '#3B82F6'); ?>20; color: <?php echo e($event->category->color ?? '#3B82F6'); ?>;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($event->category->icon) && $event->category->icon): ?>
                                            <i class="fas fa-<?php echo e($event->category->icon); ?> mr-1"></i>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php echo e($event->category->name ?? $event->category); ?>

                                    </span>
                                <?php elseif($event->category && is_string($event->category)): ?>
                        ...
                        <h4 class="font-bold text-xl text-blue-800 leading-tight line-clamp-2 mb-3" style="height: 56px;"><?php echo e($event->name); ?></h4>
                        
                        <p class="text-sm text-blue-600 leading-relaxed line-clamp-3 mb-4" style="height: 63px;"><?php echo e($event->description); ?></p>
                        ...
                        <div class="mb-4 flex-shrink-0" style="height: 50px;">
                            <div class="flex items-center gap-2 text-sm text-blue-600 mb-4" style="height: 20px;">
                                ...
                                <span class="font-medium text-xs truncate"><?php echo e($event->date ? \Carbon\Carbon::parse($event->date)->format('M d, Y H:i') : 'TBD'); ?></span>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-blue-600" style="height: 20px;">
                                ...
                                <span class="font-medium text-xs truncate"><?php echo e($event->venue->name ?? 'TBD'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 mt-auto flex-shrink-0">
                            <a href="<?php echo e(route('bookings.create.for.event', $event)); ?>" class="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-2.5 px-4 rounded-xl transition-all duration-300 hover:shadow-lg text-sm">
                            ...
                            <a href="<?php echo e(route('events.show', $event)); ?>" class="inline-flex items-center justify-center gap-2 bg-white border-2 border-blue-400 hover:bg-blue-50 text-blue-700 font-bold py-2.5 px-4 rounded-xl transition-all duration-300 hover:shadow-lg text-sm">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trendingEvents && $trendingEvents->count() > 0): ?>
            <div class="bg-gradient-to-br from-blue-50 via-white to-blue-100 rounded-2xl p-6 shadow-lg animate-slide-in-right">
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 stagger-animation">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $trendingEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl p-6 shadow-sm card-hover border border-blue-100 flex flex-col" style="height: 520px;">
                        <div class="flex justify-between items-start mb-3" style="height: 28px;">
                            <div class="flex flex-wrap gap-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->category && is_object($event->category)): ?>
                                    <span class="text-xs font-bold px-2 py-1 rounded-full" 
                                          style="background-color: <?php echo e($event->category->color ?? '#F59E0B'); ?>20; color: <?php echo e($event->category->color ?? '#F59E0B'); ?>;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($event->category->icon) && $event->category->icon): ?>
                                            <i class="fas fa-<?php echo e($event->category->icon); ?> mr-1"></i>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php echo e($event->category->name ?? $event->category); ?>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full font-bold"><?php echo e($event->bookings_count); ?> bookings</span>
                            </div>
                        </div>
                        
                        <h4 class="font-black text-xl text-blue-800 leading-tight line-clamp-2 mb-3" style="height: 56px;"><?php echo e($event->name); ?></h4>
                        ...
                        <div class="flex flex-col gap-2 mt-auto flex-shrink-0">
                            <a href="<?php echo e(route('events.show', $event)); ?>" class="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold py-2.5 px-4 rounded-xl transition-all duration-300 hover:shadow-lg text-sm">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                            ...
                            <a href="<?php echo e(route('bookings.create.for.event', $event)); ?>" class="inline-flex items-center justify-center gap-2 bg-white border-2 border-blue-400 hover:bg-blue-50 text-blue-700 font-bold py-2.5 px-4 rounded-xl transition-all duration-300 hover:shadow-lg text-sm">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.1 5H19M7 13l-1.1-5M7 13h10m0 0v8a2 2 0 01-2 2H9a2 2 0 01-2-2v-8z"></path>
                                </svg>
                                Book Now
            ...
            <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-6 shadow-xl text-white animate-scale-in shimmer">
                <div class="text-center mb-4">
                    ...
                    <p class="text-blue-100">Member since <?php echo e($userStats['member_since']); ?></p>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 stagger-animation">
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-white/20 transition-all duration-300 hover:scale-110 card-hover">
                        <div class="text-4xl font-black mb-4"><?php echo e($userStats['events_attended']); ?></div>
                        <div class="text-sm text-blue-100 font-semibold">Events Booked</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-white/20 transition-all duration-300 hover:scale-110 card-hover">
                        <div class="text-4xl font-black mb-4 animate-pulse-soft"><?php echo e($userStats['upcoming_bookings']); ?></div>
                        <div class="text-sm text-blue-100 font-semibold">Upcoming</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-white/20 transition-all duration-300 hover:scale-110 card-hover">
                        <div class="text-4xl font-black mb-4"><?php echo e($userStats['favorites_count']); ?></div>
                        <div class="text-sm text-blue-100 font-semibold">Favorites</div>
                    </div>
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-white/20 transition-all duration-300 hover:scale-110 card-hover">
                        <div class="text-4xl font-black mb-4"><?php echo e(count(auth()->user()->interests ?? [])); ?></div>
            ...
            <div id="analytics-tab" class="tab-content animate-fadeIn hidden">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-blue-50 p-6 mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $enhancedStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-gradient-to-br from-white to-gray-50  rounded-xl p-6 border border-blue-50 hover:shadow-lg transition-all duration-300 group">
                            <div class="flex items-center justify-between mb-4">
                                <div class="p-3 rounded-xl bg-<?php echo e($stat['color']); ?>-50  group-hover:scale-110 transition-transform duration-200">
                                    <svg class="w-6 h-6 text-<?php echo e($stat['color']); ?>-600 " fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo $stat['icon']; ?>"></path>
                                    </svg>
                                </div>
                                <div class="text-right">
                                    <p class="text-3xl font-bold text-blue-800 group-hover:scale-105 transition-transform duration-200"><?php echo e($stat['value']); ?></p>
                                    <p class="text-sm font-medium text-blue-600 mt-1"><?php echo e($stat['label']); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="h-1 bg-gradient-to-r from-<?php echo e($stat['color']); ?>-200 to-<?php echo e($stat['color']); ?>-400  rounded-full flex-1"></div>
                                <span class="text-xs <?php echo e($stat['changeColor']); ?> font-medium ml-2"><?php echo e($stat['change']); ?></span>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                ...
                <div class="bg-gradient-to-br from-green-50 via-white to-green-100  rounded-xl shadow-sm border border-green-200 border-green-200 p-6 mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $creatorStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white  rounded-xl p-6 border border-green-200 border-green-200/50 hover:shadow-lg  transition-all duration-300 group">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="text-right">
                                    <p class="text-3xl font-bold text-green-900 text-green-800 group-hover:scale-105 transition-transform duration-200"><?php echo e($stat['value']); ?></p>
                                    <p class="text-sm font-medium text-green-600 text-green-600 mt-1"><?php echo e($stat['label']); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="h-1 bg-gradient-to-r from-<?php echo e($stat['color']); ?>-200 to-<?php echo e($stat['color']); ?>-400  rounded-full flex-1"></div>
            ...
            <div id="events-tab" class="tab-content animate-fadeIn">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredEvents->count()): ?>
            <div class="bg-white rounded-3xl shadow-sm p-6 border border-blue-50 animate-fadeInUp animate-on-scroll">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $featuredEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group relative animate-fadeInUp" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s">
                ...
                <div class="relative bg-white border border-blue-50 rounded-3xl p-6
                            ...
                            <div class="space-y-2 mb-4">
                                ...
                                <div class="flex items-center gap-2 text-sm text-blue-700 group-hover:translate-x-1 transition-transform duration-300" style="transition-delay: 50ms">
                                    ...
                                    <span class="font-medium"><?php echo e($event->venue->name ?? 'TBD'); ?></span>
                                </div>
                            </div>
                ...
                <form method="GET" action="<?php echo e(route('user.dashboard')); ?>"
                    ...
                    <div class="flex flex-col lg:flex-row gap-4">
                        ...
                        <select name="category"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <select name="type"
                            ...
                            <option value="free" <?php echo e($currentType=='free'?'selected':''); ?>>Free Events</option>
                            <option value="paid" <?php echo e($currentType=='paid'?'selected':''); ?>>Paid Events</option>
                        </select>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentSearch || $currentCategory || $currentType || request('date_from') || request('date_to') || request('price_min') || request('price_max') || request('location')): ?>
                    ...
                    <div x-data="{ showAdvanced: <?php echo e(request('date_from') || request('date_to') || request('price_min') || request('price_max') || request('location') ? 'true' : 'false'); ?> }">
                        ...
                        <div x-show="showAdvanced" x-transition:enter="transition ease-out duration-200" 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="relative">
                                            <input type="number" name="price_min" value="<?php echo e(request('price_min')); ?>" placeholder="Min"
                                                   min="0" step="0.01"
                                                   class="w-full px-3 py-6 rounded-lg border border-blue-200 focus:ring-2 focus:ring-blue-300 focus:border-blue-300 text-sm">
                                        </div>
                                        <div class="relative">
                                            <input type="number" name="price_max" value="<?php echo e(request('price_max')); ?>" placeholder="Max"
                                                   min="0" step="0.01"
                                                   class="w-full px-3 py-6 rounded-lg border border-blue-200 focus:ring-2 focus:ring-blue-300 focus:border-blue-300 text-sm">
                                        </div>
                                    </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="location" value="<?php echo e(request('location')); ?>" placeholder="City, venue, or address..."
            ...
            <div class="bg-white rounded-2xl p-6 border border-blue-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 animate-fadeInUp flex flex-col" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s; height: 520px;">
                    
                    <!-- Status Badge -->
                    <div class="flex justify-end mb-3" style="height: 28px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strtolower($event->status ?? 'active') == 'active'): ?>
                    ...
                    <div class="flex flex-col gap-2 mt-auto flex-shrink-0">
                        ...
                        <form method="POST" action="<?php echo e(route('favorites.toggle', $event)); ?>" class="w-full">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="w-full inline-flex items-center justify-center gap-2
                                                         bg-white border-2 <?php echo e(auth()->user()->favoritedEvents()->where('event_id', $event->id)->exists() ? 'border-red-400 hover:bg-red-50' : 'border-yellow-400 hover:bg-yellow-50'); ?>

                                                         text-blue-700 px-4 py-2.5 rounded-xl font-bold text-sm
                                                         shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                                <svg class="w-4 h-4 <?php echo e(auth()->user()->favoritedEvents()->where('event_id', $event->id)->exists() ? 'text-blue-500' : 'text-blue-300'); ?>" fill="<?php echo e(auth()->user()->favoritedEvents()->where('event_id', $event->id)->exists() ? 'currentColor' : 'none'); ?>" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                                </svg>
                                <?php echo e(auth()->user()->favoritedEvents()->where('event_id', $event->id)->exists() ? 'Remove' : 'Add to Favorites'); ?>
            ...
            <div id="tickets-tab" class="tab-content hidden animate-fadeIn">
                <div class="">
                    <h3 class="text-xl font-bold text-blue-900 mb-4">My Tickets (<?php echo e($myTickets->count()); ?>)</h3>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($myTickets->count() > 0): ?>
                    <div class="space-y-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $myTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4
                                    ...
                                    group animate-fadeInUp" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s">
                            <div class="flex-1">
                                <p class="font-bold text-lg text-black mb-3 group-hover:text-blue-600 transition-colors duration-300">
                                    <?php echo e($booking->event->name); ?>

                                </p>
                                <p class="text-sm text-blue-800 mb-3">
                                    Ticket Type: <span class="font-semibold text-black"><?php echo e($booking->ticket->type); ?></span>
                                </p>
                                <p class="text-sm text-blue-800">
                                    Booked: <?php echo e($booking->booking_date ? \Carbon\Carbon::parse($booking->booking_date)->format('M d, Y') : $booking->created_at->format('M d, Y')); ?>
                            ...
                            <div class="flex flex-col items-end gap-2">
                                <span class="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-2.5 rounded-lg
                                    ...
                                    $<?php echo e(number_format($booking->ticket->price, 2)); ?>

                                </span>
                                <span class="text-xs px-3 py-1 rounded-full font-semibold
                                    <?php echo e($booking->status === 'confirmed' ? 'bg-blue-100 text-blue-700' : 'bg-blue-100 text-blue-600'); ?>">
            ...
            <div id="favorites-tab" class="tab-content hidden animate-fadeIn">
                <div class="">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($myFavorites->count() > 0): ?>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $myFavorites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group relative animate-fadeInUp" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s">
                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-white rounded-2xl p-6 shadow-lg border border-blue-100 sticky top-6">
                                ...
                                <div id="events-list" class="space-y-3 max-h-[600px] overflow-y-auto">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $availableEvents->sortBy('date')->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->date && \Carbon\Carbon::parse($event->date)->isFuture()): ?>
                                        <div class="group p-4 bg-gradient-to-br from-blue-50 to-white hover:from-blue-100 hover:to-blue-50 rounded-xl transition-all duration-300 border border-blue-200 hover:shadow-md" data-event-date="<?php echo e(\Carbon\Carbon::parse($event->date)->format('Y-m-d')); ?>">
                                            <div class="flex items-start justify-between mb-4">
                                                <p class="font-bold text-blue-800 text-sm line-clamp-2 flex-1"><?php echo e($event->name); ?></p>
                                            ...
                                            <div class="flex items-center gap-2 text-xs text-blue-600 mb-3">
                                                ...
                                                <span><?php echo e(\Carbon\Carbon::parse($event->date)->format('h:i A')); ?></span>
                                            </div>
                                            <a href="<?php echo e(route('events.show', $event)); ?>" class="inline-flex items-center gap-1 text-blue-600 hover:text-blue-700 text-xs font-bold group-hover:gap-2 transition-all duration-300">
                                                View Details
    ...
    <div class=\"fixed bottom-6 right-6 z-50 sm:hidden\">
        <a href=\"<?php echo e(route('event-requests.create')); ?>\"
    ...
    <script>
        ...
        const events = [
            <?php $__currentLoopData = $availableEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($event->date): ?>
                {
                    date: '<?php echo e(\Carbon\Carbon::parse($event->date)->format('Y-m-d')); ?>',
                    name: '<?php echo e(addslashes($event->name)); ?>',
        ...
        const userBookings = [
            <?php $__currentLoopData = $myTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($booking->event && $booking->event->date): ?>
                {
                    date: '<?php echo e(\Carbon\Carbon::parse($booking->event->date)->format('Y-m-d')); ?>',
                    name: '<?php echo e(addslashes($booking->event->name)); ?>',
                    id: '<?php echo e($booking->event->id); ?>'
                },
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ];
        ...
        (function () {
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('active_tab')): ?>
                switchTab("<?php echo e(session('active_tab')); ?>");
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <script>
        ...
        function initAnalyticsCharts() {
            ...
            // Data from backend
            const monthlyBookings = <?php echo json_encode($monthlyBookings, 15, 512) ?>;
            ...
            const hasCreatedEvents = <?php echo json_encode($hasCreatedEvents, 15, 512) ?>;
            const creatorAnalytics = <?php echo json_encode($creatorAnalytics, 15, 512) ?>;
    ...
    <script>
        ...
        const eventLocations = [
            <?php $__currentLoopData = $availableEvents->filter(function($event) {
            ...
            {
                id: <?php echo e($event->id); ?>,
                name: <?php echo json_encode($event->name, 15, 512) ?>,
                date: <?php echo json_encode($event->date ? \Carbon\Carbon::parse($event->date)->format('M d, Y H:i') : 'TBD', 512) ?>,
                location: <?php echo json_encode($event->venue ? $event->venue->name : ($event->location ?? 'Location TBD'), 15, 512) ?>,
                category: <?php echo json_encode($event->category->name ?? 'General', 15, 512) ?>,
                is_featured: <?php echo e($event->is_featured ? 'true' : 'false'); ?>,
                latitude: <?php echo e($lat); ?>,
                longitude: <?php echo e($lng); ?>,
                url: <?php echo json_encode(route('events.show', $event), 512) ?>,
                price: <?php echo json_encode($event->price ? '$' . number_format($event->price, 2) : 'Free', 512) ?>,
                venue_name: <?php echo json_encode($event->venue ? $event->venue->name : 'TBD', 15, 512) ?>,
                address: <?php echo json_encode($event->venue ? ($event->venue->address ?? 'Address not available') : ($event->location ?? 'Location TBD'), 15, 512) ?>
            },
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ];
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('services.google_maps.api_key')): ?>
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('services.google_maps.api_key')); ?>&libraries=places&callback=initMap&loading=async" async defer></script>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\Users\Zealda Junior\Desktop\Event\event_management\resources\views/user-dashboard.blade.php ENDPATH**/ ?>