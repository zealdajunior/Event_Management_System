        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-2 sm:ms-10 sm:flex">
                    ...
                    <a href="<?php echo e(route('calendar.index')); ?>" wire:navigate 
                       class="<?php echo e(request()->routeIs('calendar.*') ? 'bg-white/20 text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white'); ?> px-4 py-2 rounded-xl font-bold text-sm transition-all duration-300">
                        Calendar
                    </a>
                    
                    <a href="<?php echo e(route('calendar.map')); ?>" wire:navigate 
                       class="<?php echo e(request()->routeIs('calendar.map') ? 'bg-white/20 text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white'); ?> px-4 py-2 rounded-xl font-bold text-sm transition-all duration-300">
                        Map
                    </a>
                </div>
            </div>
...
<?php endif; ?>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-blue-600">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <a href="<?php echo e(route('calendar.index')); ?>" wire:navigate 
               class="<?php echo e(request()->routeIs('calendar.*') ? 'bg-white/20 text-white border-l-4 border-white' : 'text-blue-100 hover:bg-white/10 hover:text-white border-l-4 border-transparent'); ?> block ps-3 pe-4 py-2 text-base font-bold transition-all duration-300">
                Calendar
            </a>
            
            <a href="<?php echo e(route('calendar.map')); ?>" wire:navigate 
               class="<?php echo e(request()->routeIs('calendar.map') ? 'bg-white/20 text-white border-l-4 border-white' : 'text-blue-100 hover:bg-white/10 hover:text-white border-l-4 border-transparent'); ?> block ps-3 pe-4 py-2 text-base font-bold transition-all duration-300">
                Map
            </a>
            ...
            <div class="px-3 py-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->role === 'admin'): ?>
                    <a href="<?php echo e(route('events.create')); ?>" wire:navigate 
                    ...
                    <a href="<?php echo e(route('venues.create')); ?>" wire:navigate 
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('events.create.user')); ?>" wire:navigate 
                       class="flex items-center gap-3 text-blue-100 hover:bg-white/10 hover:text-white ps-2 pe-4 py-2 rounded-lg font-semibold text-sm transition-all duration-300 mb-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
                    ...
                    <a href="<?php echo e(route('event-requests.create')); ?>" wire:navigate 
                       class="flex items-center gap-3 text-blue-100 hover:bg-white/10 hover:text-white ps-2 pe-4 py-2 rounded-lg font-semibold text-sm transition-all duration-300">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
