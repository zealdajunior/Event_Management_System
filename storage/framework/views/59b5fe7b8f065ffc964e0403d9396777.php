                    ...
                    <div class="flex items-center space-x-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->role === 'admin'): ?>
                            <span class="inline-flex items-center px-3 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-purple-500 to-blue-600 text-white">
                                ...
                                <?php if(auth()->user()->is_super_admin): ?> Super Admin <?php else: ?> Admin <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </span>
            ...
            <div class="bg-gradient-to-r from-white to-blue-50 rounded-2xl shadow-sm border border-blue-50 p-6">
                <div class="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        <h2 class="text-2xl font-bold text-black mb-2"><?php echo e(auth()->user()->name); ?></h2>
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-100 hover:shadow-md transition-all duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-black"><?php echo e($userEvents); ?></p>
                        </div>
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-100 hover:shadow-md transition-all duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-black"><?php echo e($userBookings); ?></p>
                        </div>
                        <div class="p-3 rounded-lg bg-blue-50">
                            <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-100 hover:shadow-md transition-all duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-black"><?php echo e($userFavorites); ?></p>
                        </div>
                        <div class="p-3 rounded-lg bg-blue-50">
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-100 hover:shadow-md transition-all duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-black">$<?php echo e(number_format($userRevenue, 2)); ?></p>
                        </div>
                        <div class="p-3 rounded-lg bg-blue-50">
                            <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
[$__name, $__params] = $__split('profile.update-profile-photo', []);
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-306583241-3', null);
...
?>
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-blue-50 p-6">
                        ...
                        <div class="space-y-2">
                            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-blue-50 transition-all duration-200 group">
                            ...
                            <a href="<?php echo e(route('events.create.user')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-blue-50 transition-all duration-200 group">
                                <div class="p-2 bg-blue-100 rounded-lg group-hover:bg-blue-200 transition-colors">
                                    <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="<?php echo e(route('events.index')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-blue-50 transition-all duration-200 group">
                                <div class="p-2 bg-blue-100 rounded-lg group-hover:bg-blue-200 transition-colors">
                                    <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                    </svg>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->role === 'admin'): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 p-3 rounded-xl hover:bg-blue-50 transition-all duration-200 group">
                                <div class="p-2 bg-blue-100 rounded-lg group-hover:bg-blue-200 transition-colors">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-blue-50 p-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                ...
                                <span class="text-sm font-bold text-black"><?php echo e(ucfirst(auth()->user()->role)); ?></span>
                            </div>
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <span class="text-sm font-medium text-gray-900">Member Since</span>
                                <span class="text-sm font-bold text-black"><?php echo e(auth()->user()->created_at->format('M Y')); ?></span>
                            </div>
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <span class="text-sm font-medium text-gray-900">Last Updated</span>
                                <span class="text-sm font-bold text-black"><?php echo e(auth()->user()->updated_at->diffForHumans()); ?></span>
                            </div>
