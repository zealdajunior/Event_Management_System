...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Redirect to ticket page to view/download ticket
            return redirect()->route('bookings.ticket', $booking)->with('status', 'Booking created successfully! Your ticket is ready.');
        } catch (\Exception $e) {
            DB::rollBack();
