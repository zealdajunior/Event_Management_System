                                    ...
                                    @foreach($events as $event)
                                        <tr class="hover:bg-blue-50 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full {{ $event->status == 'active' ? 'bg-green-100 text-green-800 border border-green-300' : 'bg-red-100 text-red-800 border border-red-300' }}">
