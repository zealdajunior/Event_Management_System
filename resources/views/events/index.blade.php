                                    ...
                                    <div class="p-6">
                                        ...
                                        <div class="space-y-2 mb-4">
                                            ...
                                            <div class="flex items-center gap-2 text-sm text-gray-600">
                                                ...
                                                <span class="font-semibold">{{ $event->date ? \Carbon\Carbon::parse($event->date)->format('M j, Y • g:i A') : 'Date TBA' }}</span>
                                            </div>
                                            ...
                                            <div class="flex items-center gap-2 text-sm text-gray-600">
                                                ...
                                                <span class="truncate">{{ $event->venue ? $event->venue->name : ($event->location ?? 'Location TBA') }}</span>
                                            </div>
                                            ...
                                            @if($event->capacity)
                                                <div class="flex items-center gap-2 text-sm text-gray-600">
                                                    ...
                                                    <span><strong class="text-blue-600">{{ $bookingsCount }}</strong> / {{ $event->capacity }} attending</span>
                                                </div>
                                            @endif
                                        </div>
