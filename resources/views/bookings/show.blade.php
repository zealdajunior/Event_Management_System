                ...
                <div class="relative p-8">
                    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
                        <div>
                            ...
                            <p class="text-white/70 text-lg">Booked by {{ $booking->user ? $booking->user->name : 'Unknown User' }}</p>
                        </div>
                        ...
                        <div class="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                    ...
                                    <span class="text-white font-bold">{{ $booking->booking_date ? \Carbon\Carbon::parse($booking->booking_date)->format('M d, Y H:i') : 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                    <span class="text-white/70 font-semibold">Created:</span>
                                    <span class="text-white font-bold">{{ $booking->created_at ? \Carbon\Carbon::parse($booking->created_at)->format('M d, Y H:i') : 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                    ...
                                    <span class="text-white font-bold">{{ $booking->event->name }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                    <span class="text-white/70 font-semibold">Event Date:</span>
                                    <span class="text-white font-bold">{{ $booking->event->date ? \Carbon\Carbon::parse($booking->event->date)->format('M d, Y H:i') : 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                    <span class="text-white/70 font-semibold">Location:</span>
                                    <span class="text-white font-bold">{{ $booking->event->location }}</span>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                    ...
                                    <span class="text-white font-bold">{{ $booking->ticket->type }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                    <span class="text-white/70 font-semibold">Price:</span>
                                    <span class="text-white font-bold">${{ number_format($booking->ticket->price, 2) }}</span>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                    ...
                                    <span class="text-white font-bold">{{ $booking->user->name }}</span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                    <span class="text-white/70 font-semibold">Email:</span>
                                    <span class="text-white font-bold">{{ $booking->user->email }}</span>
                                </div>
                            </div>
                        </div>
                        @endif
