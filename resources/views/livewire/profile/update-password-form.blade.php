    ...
    <form wire:submit="updatePassword" class="space-y-5" x-data="{ 
        ...
        <div class="p-4 bg-blue-50 rounded-xl border-l-4 border-blue-500">
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    <p class="text-sm font-bold text-gray-700 mb-1">Password Requirements:</p>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input wire:model="current_password" 
                       ...
                       class="block w-full pl-10 pr-12 py-3 bg-blue-50 border-0 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all duration-300" 
                       placeholder="Enter your current password"
                       autocomplete="current-password" />
                <button type="button" 
                        @click="$wire.showCurrentPassword = !$wire.showCurrentPassword"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" 
                        @click="$wire.showNewPassword = !$wire.showNewPassword"
                        class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600">
            ...
            <div class="mt-2" x-show="$wire.password.length > 0">
                <div class="flex items-center gap-2 mb-1">
                    <span class="text-xs font-bold text-gray-600">Password Strength:</span>
                    <span class="text-xs font-bold"
                          ...
                          x-text="passwordStrength <= 2 ? 'Weak' : passwordStrength === 3 ? 'Fair' : passwordStrength === 4 ? 'Good' : 'Strong'">
                    </span>
                </div>
                <div class="flex gap-1">
                    <div class="h-2 flex-1 rounded-full transition-all duration-300"
                         :class="passwordStrength >= 1 ? (passwordStrength <= 2 ? 'bg-red-500' : passwordStrength === 3 ? 'bg-yellow-500' : passwordStrength === 4 ? 'bg-blue-500' : 'bg-green-500') : 'bg-gray-200'"></div>
                    <div class="h-2 flex-1 rounded-full transition-all duration-300"
                         :class="passwordStrength >= 2 ? (passwordStrength <= 2 ? 'bg-red-500' : passwordStrength === 3 ? 'bg-yellow-500' : passwordStrength === 4 ? 'bg-blue-500' : 'bg-green-500') : 'bg-gray-200'"></div>
                    <div class="h-2 flex-1 rounded-full transition-all duration-300"
                         :class="passwordStrength >= 3 ? (passwordStrength === 3 ? 'bg-yellow-500' : passwordStrength === 4 ? 'bg-blue-500' : 'bg-green-500') : 'bg-gray-200'"></div>
                    <div class="h-2 flex-1 rounded-full transition-all duration-300"
                         :class="passwordStrength >= 4 ? (passwordStrength === 4 ? 'bg-blue-500' : 'bg-green-500') : 'bg-gray-200'"></div>
                    <div class="h-2 flex-1 rounded-full transition-all duration-300"
                         :class="passwordStrength >= 5 ? 'bg-green-500' : 'bg-gray-200'"></div>
                </div>
            </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input wire:model="password_confirmation" 
                       ...
                       autocomplete="new-password" />
                <button type="button" 
                        @click="$wire.showConfirmPassword = !$wire.showConfirmPassword"
                        class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600">
        ...
        <div class="flex items-center gap-3 pt-4 border-t border-gray-200">
            ...
            <x-action-message class="text-sm font-bold text-blue-600 flex items-center gap-2" on="password-updated">
