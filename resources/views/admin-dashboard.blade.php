                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-xl p-6 border border-gray-100 hover:shadow-md transition-all duration-200 group">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-blue-600 mb-1">{{ $stat['label'] }}</p>
                                <p class="text-3xl font-bold text-blue-800">{{ $stat['value'] }}</p>
                            </div>
                                ...
                                @foreach($recentEvents as $event)
                                    <div class="group relative bg-white p-6 rounded-2xl shadow-lg border border-blue-100
                                        ...
                                        <div class="relative flex flex-col h-full">
                                            ...
                                            <h4 class="text-xl font-bold text-blue-900 mb-2 group-hover:text-blue-600 transition-colors duration-300 line-clamp-2">{{ $event->name }}</h4>
                                            <p class="text-blue-600 text-sm mb-4 line-clamp-2 flex-shrink-0">{{ $event->description }}</p>
                                        ...
                                        <div class="relative flex flex-col h-full">
                                            ...
                                            <div class="space-y-3 mb-4 flex-grow">
                                                <div class="flex items-center gap-2 text-sm">
                                                    ...
                                                    <span class="font-semibold text-blue-900">{{ $booking->user->name }}</span>
                                                </div>
                                                <div class="flex items-center gap-2 text-sm text-blue-600">
                                                    <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                            ...
                            <div class="group bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-3xl font-black text-blue-800">{{ \App\Models\User::where('role', 'admin')->count() }}</p>
                                        <div class="flex items-center mt-2">
                                            <svg class="w-4 h-4 text-blue-500 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                            </svg>
                            ...
                            <div class="group bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-3xl font-black text-blue-800">{{ \App\Models\User::where('role', 'user')->count() }}</p>
                                        <div class="flex items-center mt-2">
                                            <svg class="w-4 h-4 text-blue-500 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                                            </svg>
                                        ...
                                        <div class="group bg-white p-5 rounded-xl border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all duration-300">
                                            <div class="flex items-start gap-4">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <h5 class="text-blue-700 font-bold text-sm truncate">{{ $user->name ?? 'N/A' }}</h5>
                                                    <p class="text-blue-600 text-xs truncate">{{ $user->email ?? 'N/A' }}</p>
                                                    <div class="flex items-center gap-2 mt-2">
                                                        ...
                                                        <span class="text-blue-500 text-xs">{{ $user->created_at ? $user->created_at->diffForHumans() : 'Recently' }}</span>
                                                    </div>
                                                </div>
                                        </div>
                                    </div>
                ...
                <div class="bg-white rounded-3xl shadow-sm p-8 border border-blue-50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            ...
                            <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-md">
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-blue-300 h-2 rounded-full" style="width: {{ $totalBookings > 0 ? ($cancelledBookings / $totalBookings * 100) : 0 }}%"></div>
                                </div>
                            </div>
                    </div>
